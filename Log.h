...
public:
	enum {
		LOG_TRACE = 1,		//打印程序运行堆栈，跟踪记录数据信息，与DEBUG相比更细致化的记录信息
		LOG_DEBUG = 2,		//细粒度信息事件对调试应用程序是非常有帮助的
		LOG_INFO = 3,			//消息在粗粒度级别上突出强调应用程序的运行过程
		LOG_WARN = 4,			//会出现潜在错误的情形
		LOG_ERROR = 5,		//虽然发生错误事件，但仍然不影响系统的继续运行
